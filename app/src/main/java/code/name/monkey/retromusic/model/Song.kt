...
open class Song(
    ...
    open val playCount: Int = 0,
    open val playTime: Long = 0L
) : Parcelable {

    fun withPlayStats(playCount: Int, playTime: Long): Song = Song(
        ...
        artistId = artistId, artistName = artistName, composer = composer, albumArtist = albumArtist,
        playCount = playCount, playTime = playTime
    )
