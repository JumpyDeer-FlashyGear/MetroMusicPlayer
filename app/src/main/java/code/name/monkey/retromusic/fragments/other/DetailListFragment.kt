...
class DetailListFragment : AbsMainActivityFragment(R.layout.fragment_playlist_detail),
    ...
    private fun lastAddedSongs() {
        binding.toolbarTitleText.setText(R.string.last_added)
    ...
    private fun topPlayed() {
        binding.toolbarTitleText.setText(R.string.my_top_tracks)
        val songAdapter = ShuffleButtonSongAdapter(
            requireActivity(),
            mutableListOf(),
            R.layout.item_list
        ...
        libraryViewModel.playCountSongs().observe(viewLifecycleOwner) { songs ->
            songAdapter.swapDataSet(songs)
            libraryViewModel.getTotalPlaytime(songs).observe(viewLifecycleOwner) { playtime ->
                binding.totalPlaytimeText.isVisible = true
                binding.totalPlaytimeText.text = String.format(
                    getString(R.string.label_total_playtime),
                    MusicUtil.getReadableDurationString(playtime)
                )
            }
        }
    }
    ...
    private fun loadHistory() {
        binding.toolbarTitleText.setText(R.string.history)
    ...
    private fun loadFavorite() {
        binding.toolbarTitleText.setText(R.string.favorites)
