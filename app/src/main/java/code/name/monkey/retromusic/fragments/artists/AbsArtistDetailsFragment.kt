...
abstract class AbsArtistDetailsFragment : AbsMainActivityFragment(R.layout.fragment_artist_details),
    ...
    private fun showArtist(artist: Artist) {
        ...
        binding.artistText.text = String.format(
            "%s • %s",
        ...
        detailsViewModel.getTotalPlaytime(artist.songs).observe(viewLifecycleOwner) { playtime ->
            binding.artistPlayTimeText.text = String.format(
                "Played for %s",
